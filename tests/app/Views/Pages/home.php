                ...
                <div class="carousel-inner">
                    <?php foreach ($headline as $row => $brt) { ?>
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="<?= $brt->gambar; ?>" style="object-fit: cover;">
            ...
            <div class="row ">
                <?php foreach ($pilihan2 as $row => $brt) { ?>
                    <div class="col-sm-3 mb-4">
                        <div class="rotate-img">
                            <img style="width: 70px;" src="<?= $brt->gambar; ?>" alt="banner" class="img-fluid" />
                        </div>
                    </div>
                    <div class="col-sm-8 mb-4">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                ...
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="<?= $brt->gambar; ?>" alt="">
        ...
        <?php foreach ($video as $row => $brt) { ?>
            <div class="col-md-6">
                <div class="embed-responsive embed-responsive-16by9" style="height: 300px;">
                    <iframe width="600" height="400" src="<?= $brt->video_youtube; ?>"> </iframe>
