  ...
  <div class="container">
    <div class="d-lg-flex align-items-center justify-content-between">
      <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
        ...
        <small>
          <?php echo $list_berita->judul_berita ?>
        </small>
      </div>
    </div>
  </div>
  ...
  <div class="row px-xl-5 mb-500">
    ...
    <div class="container-fluid mb-3">
      <div class="row px-xl-3">
        ...
        <div class="col-lg-7">
          <a class="btn btn-success mb-2 text-dark " href="<?= base_url() ?>/Internasional"><?= $list_berita->id_kategori ?></a>
          <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
            <div class="rotate-img" style="height: 190px;">
              ...
              <p class="fs-13 text-muted mb-0">
                <small class="far fa-clock"> </small> <?= $list_berita->created_at ?>
              </p>
              <img src="<?= base_url($list_berita->gambar) ?>" alt="banner" class="img-fluid" />
              <p class="fs-13 text-muted mb-0">
                <small> </small> <?= $list_berita->ket_gambar ?>
              </p>
              <p class="fs-13 text-muted mb-0">
                <small> </small> <?= $list_berita->isi_berita ?>
              </p>
