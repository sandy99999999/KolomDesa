					...
					<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								<li><a  href="http://localhost/KolomDesa/public/Dashboard_Admin"> Dashboard <span ></span></a>
								...
								<li><a><i class="fa fa-edit"></i> Modul Berita <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										...
										<li><a href="<?= base_url()?>/Komentar_Berita">Komentar Berita</a></li>
										<li><a href="<?= base_url()?>/Sensor_Berita">Sensor Berita</a></li>
										<li><a href="<?= base_url()?>/Berita_Foto">Berita Foto</a></li>
										<li><a href="<?= base_url()?>/GaleriFoto_Berita">Gallery Foto Berita</a><!-- <a href="invoice.html">Invoice</a></li>
								...
								<li><a><i class="fa fa-image"></i> Modul Video <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										...
										<li><a href="<?= base_url()?>/Komentar_Video">Komentar Video</a></li>
									</ul>
								</li>
