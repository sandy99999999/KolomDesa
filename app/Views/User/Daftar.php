          ...
          <div class="animate form login_form">
            <section class="login_content">
              <form method="post" action="<?= base_url('/register/process') ?>">
                ...
                <div class="mb-3">
                  <input type="hash" class="form-control" name="email" placeholder="Email" required="" />
                </div>

                <div class="mb-3">
                  <input type="hash" class="form-control" name="password" placeholder="Password" required="" />
                </div>
                ...
                <div class="mb-3">
                  <input type="hash" class="form-control" name="no_hp" placeholder="No. WA" required="" />
                </div>
