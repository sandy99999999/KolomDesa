...
<head>
    ...
    <link href="<?= base_url('assets3') ?>/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css"
        rel="stylesheet">
    <!-- JQVMap -->
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="http://localhost:8888/KolomDesa/public/" class="site_title"><i class="fa fa-paw"></i>
                            <span>Kolom Desa</span></a>
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="http://localhost:8888/KolomDesa/public/Dashboard_Admin"> Dashboard
                                        <span></span></a>
                                ...
                                <li><a><i class="fa fa-desktop"></i> Menu Utama <span
                                ...
                                <li><a><i class="fa fa-edit"></i> Modul Berita <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="<?= base_url() ?>/berita_list">Berita, dll.</a></li>
                                        <!-- <li><a href="<= base_url()?>/Tag_Berita">Tag Berita</a></li> -->
                                        <li><a href="<?= base_url('berita/komentar/') ?>">List Komentar</a></li>
                                        <!-- <li><a href="<= base_url()?>/Sensor_Berita">Sensor Berita</a></li> -->
                                        <!-- <li><a href="<= base_url() ?>/Berita_Foto">Berita Foto</a></li> -->
                                        <!-- <li><a href="<?= base_url() ?>/desawisata">Desa Wisata</a> -->
                                        <!-- <li><a href="<?= base_url() ?>/GaleriFoto_Berita">Bum Desa</a> -->
                                        <!-- <a href="invoice.html">Invoice</a></li>
										<li><a href="inbox.html">Inbox</a></li>
										<li><a href="calendar.html">Calendar</a></li> -->
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-image"></i> Modul Video <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                ...
                                <li><a><i class="fa fa-bar-chart-o"></i>Modul Iklan <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                ...
                                <li><a><i class="fa fa-wifi"></i>Modul Interaksi <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li class="submenu-item ">
                        ...
                        <div class="menu_section">
                            <h3>User Menu</h3>
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-cogs"></i> Modul User <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li class="submenu-item ">
                                    ...
                                    <li class="nav-item">
                                        <a class="dropdown-item">
                                            <span class="image"><img
                                                    src="<?= base_url('assets3') ?>/production/images/img.jpg"
