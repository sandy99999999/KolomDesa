  ...
  <div class="right_col" role="main">
      <div class="card">
          ...
          <div class="card-body">
              ...
              <?php endif; ?>
              <form method="post" action="<?= base_url('Foto/update/' . $foto->id_foto) ?>">
                  <?= csrf_field(); ?>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9 ">
                          <input type="text" class="form-control" name="ket_foto" value="<?= $foto->ket_foto; ?>">
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9 ">
                      <textarea id="editor" class="form-control" name="deskripsi_foto" style='height:260px' value="<?= $foto->deskripsi_foto; ?>"></textarea>
                          </div>
                      </div>
                      <script>
                        ClassicEditor
