                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    <div class="rotate-img" style="height: 190px;">
                        ...
                        <p class="fs-13 text-muted mb-0">
                            <small class="far fa-clock"> </small> <?= $foto->created_at ?>
                        </p>
                        <img src="<?= base_url('Berita/' . $foto->list_foto); ?>" alt="banner" class="img-fluid" />
                        <p class="fs-13 text-muted mt-2">
                            <small> </small> <?= $foto->ket_foto ?>
                        </p>
                        <p class="fs-13 text-muted mt-2">
                            <small> </small> <?= $foto->deskripsi_foto ?>
                        </p>
