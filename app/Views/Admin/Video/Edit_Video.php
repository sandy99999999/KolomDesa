          ...
          <div class="card-body">
              ...
              <form method="post" action="<?= base_url('Video/update/' . $video->id_video) ?>">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9 ">
                          <input type="text" class="form-control" name="ket_video" value="<?= $video->ket_video; ?>">
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9 ">
                          <input type="text" class="form-control" name="deskripsi_video" value="<?= $video->deskripsi_video; ?>">
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9 ">
                          <input type="text" class="form-control" id="contohupload1" placeholder="contoh : https://www.youtube.com/embed/8k0lvd7XqaY" name="list_video" value="<?= $video->list_video; ?>">
                      </div>
                  </div>
