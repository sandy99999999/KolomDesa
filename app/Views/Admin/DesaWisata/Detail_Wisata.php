        ...
        <div class="col-lg-8">
          ...
          <div class="row mt-4">
            <h2 class="tombol_share">
              ...
              <a href="http://www.facebook.com/share/url=<?= base_url('berita/detail/' . $list_berita->sub_judul); ?>" class="text-primary fab fa-facebook-square"></a>
              <a href="https://twitter.com/share?url=<?= base_url('berita/detail/' . $list_berita->sub_judul); ?>" class="fab fa-twitter-square"></a>
              <a href="https://telegram.me/share/url=<?= base_url('berita/detail/' . $list_berita->sub_judul); ?>" class="text-info fab fa-telegram"></a>
              <a href="https://api.whatsapp.com/send?text=<?= base_url('berita/detail/' . $list_berita->sub_judul); ?>" class="text-success fab fa-whatsapp"></a>
            </h2>
          </div>
          <br />
